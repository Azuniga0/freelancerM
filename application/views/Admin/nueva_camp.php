                        ...
                        <form class="col-md-12" method="POST" action="nueva_camp">  
                            ...
                            <div class="form-group col-md-12">
                                    <div class="input-group">
                                        ...
                                        <textarea  class="form-control" rows="2" id="validationTooltipUsername" placeholder="Objetivo de la campaña..." name="objetivo" aria-describedby="validationTooltipUsernamePrepend"  required></textarea>
                                    </div>
                                </div>
                                <br><br>
                            </div>                  
